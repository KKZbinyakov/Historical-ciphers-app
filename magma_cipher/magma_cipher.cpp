...
{
    if (key.size() != 32)
        throw input_data_invalid("The key must consist of thirty two eight-bit numbers");
    if (data.size() % 8 != 0)
        throw input_data_invalid("The data must contain an integer number of encrypted blocks");
}
 ...
 * transforms input key data into a class object, before that, by converting the vector to an array, thirdly it calls a "encrypt" method of the magma class to en�rypt input data.
 ...
 * transforms input key data into a class object, before that, by converting the vector to an array, thirdly it calls a "decrypt" method of the magma class to de�rypt input data.
 * Handles exceptions relevant to this type of encryption
 *
 * \param[in] data is input data in the format of a vector of numbers of type uint8. The length of the vector is a multiple of eight
 * \param[in] key is input key in the format of a vector of numbers of type uint8. The length of the key is thirty-two numbers
 ...
 * synchrolink from vector to array. It calls a "gammaAlgorithm" method of the magma class to en�rypt input data.
 * Handles exceptions relevant to this type of encryption
 *
 * \param[in] data is input data in the format of a vector of numbers of type uint8. The length of the vector is a multiple of eight
 * \param[in] key is input key in the format of a vector of numbers of type uint8. The length of the key is thirty-two numbers
 ...
 * transforms input key data into a class object, before that, by converting the vector to an array, after that it transforms
 * synchrolink from vector to array. It calls a "gammaAlgorithm" method of the magma class to de�rypt input data.
 ...
 * transforms input key data into a class object, before that, by converting the vector to an array, after that it transforms
 * synchrolink from vector to array. It calls a "feedbackGammaAlgorithm" method of the magma class to en�rypt input data.
 * Handles exceptions relevant to this type of encryption
 *
 * \param[in] data is input data in the format of a vector of numbers of type uint8. The length of the vector is a multiple of eight
 * \param[in] key is input key in the format of a vector of numbers of type uint8. The length of the key is thirty-two numbers
 ...
 * transforms input key data into a class object, before that, by converting the vector to an array, after that it transforms
 * synchrolink from vector to array. It calls a "feedbackGammaAlgorithm" method of the magma class to de�rypt input data.
 * Handles exceptions relevant to this type of decryption
 *
 * \param[in] data is input data in the format of a vector of numbers of type uint8. The length of the vector is a multiple of eight
 * \param[in] key is input key in the format of a vector of numbers of type uint8. The length of the key is thirty-two numbers
