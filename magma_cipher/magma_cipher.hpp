...
private:
    ...
    std::array<std::array<uint8_t, 16>, 8> sBox = {{{0xC, 0x4, 0x6, 0x2, 0xA, 0x5, 0xB, 0x9, 0xE, 0x8, 0xD, 0x7, 0x0, 0x3, 0xF, 0x1},
                                                    ...
                                                    {0x1, 0x7, 0xE, 0xD, 0x0, 0x5, 0x8, 0x3, 0x4, 0xF, 0xA, 0x6, 0x9, 0xC, 0xB, 0x2}}}; ///< sBox is the substitution table selected for our cipher
