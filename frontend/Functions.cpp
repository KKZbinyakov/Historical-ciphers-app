...
MainWindow::MainWindow(QWidget *parent) : QWidget(parent) {
  ...
  //    &MainWindow::OnFileButtonClicked); layout->addWidget(fileButton, 6, 0,
  //    1, 1);
...
//        inputFile.close();
//    }
// if (lastClickedButton->text().toStdString() == "���� ������� ������")
//{
// std::cout << data[0];
  ...
  try {
    ...
    if (comboBox->currentText().toStdString() == "Hill ciphers") {
      if (lastClickedButton->text().toStdString() == "Hill cipher") {
        ...
        Matrix_class Key1(key_matrix, n, n);
        // std::string str {"1"};
        // std::cout << Hill_cipher_decoder(alphabet, inputText.toStdString(),
        // Key1);
        outputLine->setText(QString::fromStdString(
